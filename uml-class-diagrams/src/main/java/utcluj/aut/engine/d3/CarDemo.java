...
class CombustionEngine extends Engine{
    ...
    public boolean start() {
        System.out.println("Starting combustion engine with fuel: " + fuelType);
        return true;
    }

    @Override
    public boolean stop() {
        System.out.println("Stopping combustion engine with fuel: " + fuelType);
        return true;
    }
}
...
class ElectricEngine extends Engine{
    ...
    @Override
    public boolean start() {
        System.out.println("Starting electric engine with voltage: " + voltage);
        return true;
    }

    @Override
    public boolean stop() {
        System.out.println("Stopping electric engine with voltage: " + voltage);
        return true;
    }
}
...
abstract class Engine implements IStarter{
