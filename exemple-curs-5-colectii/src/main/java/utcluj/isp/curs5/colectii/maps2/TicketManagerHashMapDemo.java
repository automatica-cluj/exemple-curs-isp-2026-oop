package utcluj.isp.curs5.colectii.maps2;

import utcluj.isp.curs5.colectii.arraylists.AirplaneTicket;

import java.util.ArrayList;

public class TicketManagerHashMapDemo {
    public static void main(String[] args) {

        // Create a new TicketManagerHashMap object
        TicketManagerHashMap ticketManager = new TicketManagerHashMap();
        ...
        // Add the AirplaneTicket objects to the TicketManagerHashMap
